...
if (!hasReleaseSigning) {
    println("Android release signing disabled: missing keystore configuration. Release artifacts will be built unsigned.")
}

android {
    namespace = "com.treinopro.app"
    ...
    defaultConfig {
        ...
        resourceConfigurations.addAll(listOf("pt", "pt-rBR"))
    }
