                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _section('5. PAGAMENTOS, COMISSÕES E TAXAS', '· Pagamentos processados por parceiros como Mercado Pago ou Pagar.me.\n· A plataforma retém automaticamente uma comissão percentual definida por split, sendo cada parte responsável pela taxa de sua fração.\n· O percentual da comissão poderá variar, sendo sempre informado de forma clara no aplicativo antes da contratação.\n· Valores podem ser retidos em custódia em disputas (Seção 13).\n· Os saques do saldo do profissional poderão ser solicitados sem cobrança de taxa apenas nos dias 15 e 30 de cada mês.\n· O processamento levará até 1 (um) dia útil para análise e liberação.\n· Solicitações de saque feitas em datas diferentes dessas estarão sujeitas a uma taxa de 10% (dez por cento) sobre o valor solicitado, a título de saque antecipado.\n· O valor da taxa de saque antecipado será informado de forma clara no aplicativo e descontado automaticamente no momento da solicitação.\n· Cancelamentos realizados com menos de 2 (duas) horas de antecedência poderão gerar retenção de parte do valor ou taxa fixa, informada no aplicativo.\n· Em caso de falhas técnicas comprovadas (ex.: erro de cobrança duplicada), haverá reembolso integral.'),
